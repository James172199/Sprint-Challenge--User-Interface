...
semantic html is html that is written with meaning.

2. What are the 4 areas of the box model?

box model areas are Padding, Margin,
border, and content.
...
git is valuble to a team of developers as it allows you to back up every version of a directory as you edit it over and over, allowing you to commit changes and give brief description of what you have done.

5. Define mobile-first design in your own words.

mobile first design would be an easy to access and very responsive design for someone to use on their cellphone or other mobile device.
